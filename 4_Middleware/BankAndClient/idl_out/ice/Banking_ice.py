...
if 'GenericException' not in _M_Banking.__dict__:
    _M_Banking.GenericException = Ice.createTempClass()
    class GenericException(Ice.UserException):
        ...
        _ice_id = '::Banking::GenericException'

    _M_Banking._t_GenericException = IcePy.defineException('::Banking::GenericException', GenericException, (), False, None, (('message', (), IcePy._t_string, False, 0),))
    GenericException._ice_type = _M_Banking._t_GenericException

    _M_Banking.GenericException = GenericException
    del GenericException

if 'AuthenticationFailException' not in _M_Banking.__dict__:
    _M_Banking.AuthenticationFailException = Ice.createTempClass()
    class AuthenticationFailException(_M_Banking.GenericException):
        def __init__(self, message=''):
            _M_Banking.GenericException.__init__(self, message)
        ...
        _ice_id = '::Banking::AuthenticationFailException'

    _M_Banking._t_AuthenticationFailException = IcePy.defineException('::Banking::AuthenticationFailException', AuthenticationFailException, (), False, _M_Banking._t_GenericException, ())
    AuthenticationFailException._ice_type = _M_Banking._t_AuthenticationFailException

    _M_Banking.AuthenticationFailException = AuthenticationFailException
    del AuthenticationFailException

if 'InvalidBalanceException' not in _M_Banking.__dict__:
    _M_Banking.InvalidBalanceException = Ice.createTempClass()
    class InvalidBalanceException(_M_Banking.GenericException):
        def __init__(self, message=''):
            _M_Banking.GenericException.__init__(self, message)
        ...
        _ice_id = '::Banking::InvalidBalanceException'

    _M_Banking._t_InvalidBalanceException = IcePy.defineException('::Banking::InvalidBalanceException', InvalidBalanceException, (), False, _M_Banking._t_GenericException, ())
    InvalidBalanceException._ice_type = _M_Banking._t_InvalidBalanceException

    _M_Banking.InvalidBalanceException = InvalidBalanceException
    del InvalidBalanceException

if 'PeselRegisteredException' not in _M_Banking.__dict__:
    _M_Banking.PeselRegisteredException = Ice.createTempClass()
    class PeselRegisteredException(_M_Banking.GenericException):
        def __init__(self, message=''):
            _M_Banking.GenericException.__init__(self, message)
        ...
        _ice_id = '::Banking::PeselRegisteredException'

    _M_Banking._t_PeselRegisteredException = IcePy.defineException('::Banking::PeselRegisteredException', PeselRegisteredException, (), False, _M_Banking._t_GenericException, ())
    PeselRegisteredException._ice_type = _M_Banking._t_PeselRegisteredException

    _M_Banking.PeselRegisteredException = PeselRegisteredException
